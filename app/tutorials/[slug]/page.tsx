...
export async function generateStaticParams() {
  const slugs = getAllSlugs("tutorials");
...
export async function generateMetadata({
  ...
  const tutorial = getContentBySlug("tutorials", slug);
  ...
  return {
    title: `${tutorial.frontmatter.title} - Tutorials`,
      ...
      <div className="mx-auto max-w-3xl">
        ...
        <div className="mt-8 space-y-4">
          <div className="flex items-center gap-2">
            ...
            >
              {new Date(tutorial.frontmatter.date).toLocaleDateString("en-US", {
                year: "numeric",
                month: "long",
                day: "numeric",
              })}
          ...
          <div className="flex flex-wrap gap-2">
            {tutorial.frontmatter.tags.map((tag, index) => (
              <span
                key={index}
